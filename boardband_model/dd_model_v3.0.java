...
//去掉SEARCH_BJ_FLAG,SEARCH_ZJ_FLAG BFGS 0.74 0.84 0.86
...
//增加arpu,use_num  LBFGS 0.8 0.85 0.90
val pre_Data=hiveCtx.sql("select KD_RATE,(ARPU/100),(USE_NUM/1000),AGE_RATE,CMCC_KD_CNT,HOME_DEPEND,AGE_FLAG1,AGE_FLAG2,age_flag3,age_flag4,cluster2,cluster3,if(ARPU<50,1,0) low_arpu,if(ARPU>=50 and ARPU<150,1,0) mid_arpu,if(ARPU>=150,1,0) high_arpu,if(use_num<500,1,0) low_gprs,if(use_num>=500 and use_num<2000,1,0) mid_gprs,if(use_num>=2000,1,0) high_gprs,new_user_flag,LABEL from jcc_jh_dataset_16 ");

val data1=pre_Data.rdd.map(x =>(x(0).toString.toDouble, x(1).toString.toDouble,x(2).toString.toDouble,x(3).toString.toDouble,x(4).toString.toDouble, x(5).toString.toDouble,x(6).toString.toDouble,x(7).toString.toDouble,x(8).toString.toDouble,x(9).toString.toDouble,x(10).toString.toDouble,x(11).toString.toDouble,x(12).toString.toDouble,x(13).toString.toDouble,x(14).toString.toDouble,x(15).toString.toDouble,x(16).toString.toDouble,x(17).toString.toDouble,x(18).toString.toDouble));

val data2=data1.map(x=>LabeledPoint(x._19,Vectors.dense(x._1,x._2,x._3,x._4,x._5,x._6,x._7,x._8,x._9,x._10,x._11,x._12,x._13,x._14,x._15,x._16,x._17,x._18)));

//增加arpu,use_num 更改数据集hdx_jh_dataset_15_7（60万） LBFGS 0.72 0.83 0.86
val pre_Data=hiveCtx.sql("select KD_RATE,(ARPU/100),(USE_NUM/1000),AGE_RATE,CMCC_KD_CNT,HOME_DEPEND,AGE_FLAG1,AGE_FLAG2,age_flag3,age_flag4,cluster2,cluster3,if(ARPU<50,1,0) low_arpu,if(ARPU>=50 and ARPU<150,1,0) mid_arpu,if(ARPU>=150,1,0) high_arpu,if(use_num<500,1,0) low_gprs,if(use_num>=500 and use_num<2000,1,0) mid_gprs,if(use_num>=2000,1,0) high_gprs,new_user_flag,LABEL from hdx_jh_dataset_15_7 ");
